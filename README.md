...
* Fix mistakes in CMakelists.txt (there are a lot of them)
* Change some float to qreal
...
### Prerequisites:
sudo apt-get install ros-kinetic-libg2o ros-kinetic-cv-bridge liblapack-dev
...
1. Create catkin workspace & download lsd_slam to catkin_sw/src

2. Install catkin build
$ sudo apt-get update
...
4. Build lsd_slam_viewer first
$ cd catkin_ws/src/lsd_slam/lsd_slam_viewer
$ catkin bt
(catkin build this repo)

5. Build lsd_slam_core which depends on lsd_slam_viewer
$ cd catkin_ws/src/lsd_slam/lsd_slam_core
$ catkin bt
